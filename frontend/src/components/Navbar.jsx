    ...
    <article>
      <section className="flex items-center  justify-between">
        <div className="flex gap-2 items-center cursor-pointer  p-2">
          ...
          <Link to="/" className="sm:text-lg md:text-xl hover:text-red-500 ">
            Cocktails Shop{' '}
          </Link>
        </div>
        ...
        <div className="flex items-center gap-3">
          <input type="text" placeholder="Search..." className="input input-sm input-bordered input-success     " />
          <Link to="/cart">
          ...
          ></div>
          {!token ? (
            <button onClick={() => setShowLogin(true)} className="btn btn-sm  md:btn-md btn-success hover:btn-primary">
              Συνδεση
            </button>
          ) : (
